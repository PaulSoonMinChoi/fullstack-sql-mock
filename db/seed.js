...
const insertMockData = function() {
  ...
  data.forEach(product => {
    db.query(`INSERT INTO entry(item, min_cost, curr_bid, ends_in, image) VALUES('${product.item}', ${product.min_cost}, ${product.curr_bid}, ${product.ends_in}, '${product.image}')`, (err, results) => {
      if (err) {
